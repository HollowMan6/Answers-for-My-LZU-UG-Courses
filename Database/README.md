...
这个仓库是我的兰州大学“数据库原理课程设计”实验课的代码和实验报告。

# Answers for my Database programing lesson

These are my answers and reports for the LZU Course Exercise for Database course.
