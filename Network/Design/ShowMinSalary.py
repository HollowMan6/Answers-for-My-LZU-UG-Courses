...
# 兰州工作岗位的最低薪水折线图
# The Breakdown Map of Lanzhou's Minimum Salary for Lanzhou Jobs

import pyecharts.options as opts
from pyecharts.charts import Line
import DataWash
import random
jobNameList,MinSalaryList=DataWash.washMinSalary()
showNum=len(jobNameList)

list=[]
for i in range(len(jobNameList)):
    list.append((jobNameList[i],MinSalaryList[i]))
showJob=[]
...
(
    ...
    .set_global_opts(
        ...
        title_opts=opts.TitleOpts(title="兰州最低薪水折线图")
    )
    ...
    .render("./view/minSalaryLineChart.html")
)