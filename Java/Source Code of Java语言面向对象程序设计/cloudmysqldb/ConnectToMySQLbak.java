/*
* 云数据库地址：majunmysql.mysql.rds.aliyuncs.com
* 端口: 3306
* 数据库：testdb
* 账号：testmysql
* 密码：testmysql369
...
public class ConnectToMySQL {
 ...
 {
 String url = "jdbc:mysql://majunmysql.mysql.rds.aliyuncs.com:3306/testdb";  //连接MySQL中的test数据库
 Class.forName("com.mysql.jdbc.Driver");
 String userName = "testmysql";   //登录用户名
 String password = "testmysql369"; //密码
