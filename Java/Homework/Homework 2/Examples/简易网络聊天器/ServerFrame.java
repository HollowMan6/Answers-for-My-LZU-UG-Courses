...
public class ServerFrame extends JFrame implements ActionListener {
	...
	TextArea taLog;
	int a=0;//这是用来给ChatServer反馈本JFrame要被关闭的信息，从而使服务器端也同时关闭；
	...
	public ServerFrame() {
		super("WebChat 聊天服务器");
		setSize(550, 500);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);		//在这种情况下，即只点击JFrame的关闭键不会关闭服务器，点击后要关闭服务器只能在字符界面输入Ctrl+C；
		setResizable(false);
		...
		btnStop = new JButton("关闭服务器(C)");		//只有点击关闭服务器程序才会关闭该JFrame窗口同时关闭服务器
		...
		lblAbout.setText("LanZhou University, China");
