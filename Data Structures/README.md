...
这个仓库是我的兰州大学“数据结构课程设计”实验课的作业答案。实验题目:[《数据结构》课程设计——题目36学时](《数据结构》课程设计——题目36学时.doc)。

# Answers for my Data Structures programing lesson

These are my answers for the Course Exercise for Data Structures. [Questions](《数据结构》课程设计——题目36学时.doc) is provided.
