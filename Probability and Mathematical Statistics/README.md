...
此仓库是我的兰州大学“概率论与数理统计”的测试答案。

# Answers for my Probability and Mathematical Statistics Courses

This repository is my quiz answers for the LZU Probability and Mathematical Statistics Course.
