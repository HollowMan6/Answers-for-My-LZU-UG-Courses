...
HD_PWD='C:/Users/j8843/Documents/Cache_SA4/Cache_SA4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SA4_CACHE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SA4_CACHE.tcl
