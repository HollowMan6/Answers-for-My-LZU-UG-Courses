...
HD_PWD='C:/Users/j8843/Documents/Cache/Cache.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DM_CACHE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DM_CACHE.tcl
